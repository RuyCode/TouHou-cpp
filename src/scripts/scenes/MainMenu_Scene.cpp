...
MainMenu_Scene::MainMenu_Scene(sf::RenderWindow& window) 
...
void MainMenu_Scene::Draw(sf::RenderTarget& target) {
    for (int i = 0; i < 8; ++i) {
        ...
        if (i == selectedOption) {
            ...
            mainMenuText.setPosition({450.f - 5.f * i, 200.f + 30.f * i - 5.f});
        } else {
            mainMenuText.setPosition({450.f - 5.f * i, 200.f + 30.f * i});
        }
